...
const StudentList: React.FC = () => {
  ...
  const handleExport = () => {
    const dataToExport = students.map(s => ({
      ...
      'Bajo Tratamiento': s.bajoTratamiento ? 'Sí' : 'No',
      'Detalle Tratamiento': s.tratamientoDetalle || '-',
      'Trat. Médico': s['tmtMédico'] || '-',
      'Ep. Psicomotriz': s.epPsicoMotriz || '-',
      'Episodios Psicomotrices': s.episodiosPsicomotrices ? 'Sí' : 'No',
      'Detalle Episodios': s.episodiosDetalle || '-',
      'Particularidad Física': s.particularidadFisica ? 'Sí' : 'No',
      'Detalle Particularidad': s.particularidadDetalle || '-',
      Particularidad: s.particularidad || '-',
      'Cesión Imagen': s.cesionImagen ? 'Sí' : 'No',
      Asegurado: s.asegurado ? 'Sí' : 'No',
